...
function sumAndMultiply(a, b, c) {
  ...
  let sumString = `${a} and ${b} and ${c} sum to ${sumResult}.`;
  let productString = `The product of ${a} and ${b} and ${c} is ${productResult}.`;
...
function sumArray(sumArr) {
  ...
  let sumString = `${sumArr.join(
    ","
  )} was passed in as an array of numbers, and ${sumResult} is their sum.`;
...
function multiplyArray(multArr) {
  ...
  let productString = `The numbers ${multArr.join(
    ","
  )} have a product of ${productResult}.`;
